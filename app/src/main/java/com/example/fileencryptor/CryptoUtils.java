...
public class CryptoUtils {
    ...
    public static void decrypt(String key, File inputFile, File outputFile) throws CryptoException {
        ...
        doEncryption(Cipher.DECRYPT_MODE, key, inputFile, outputFile);
    }
    ...
    private static void doEncryption(int cipherMode, String key, File inputFile,
        ...
        try {
            ...
            throw new CryptoException("Error while encrypting/decrypting the file", ex);
